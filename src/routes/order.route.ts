...
router.post(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const ticket = await ticketService.findUnique({ where: { id: Number(ticketId) } });
...
router.put(
    ...
    [
        body('status')
            .isIn([OrderStatusEnum.PAYMENT_PENDING, OrderStatusEnum.CANCELLED, OrderStatusEnum.COMPLETED])
